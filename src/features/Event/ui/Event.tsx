    ...
    return (
        <div className={style.inputtext}>
            ...
            <div className={style.colorSelectorContainer}>
                <div className={style.colorSelectorTrigger} onClick={toggleColorSelector}>Color Selector</div>
                {isColorSelectorOpen && (
                    <div className={style.colorSelector}>
                        <input type="color" value={selectedColor} onChange={handleColorChange} />
                        <input type="color" value="#800080" onChange={handleColorChange} />
                        <input type="color" value="#0000FF" onChange={handleColorChange} />
                        <input type="color" value="#FF0000" onChange={handleColorChange} />
                        <input type="color" value="#FFFF00" onChange={handleColorChange} />
                    </div>
                )}
            </div>
            ...
            <div className={style.inputWithIcon} style={{ marginLeft: '-10px' }}>
