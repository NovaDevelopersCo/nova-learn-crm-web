				...
				{week.map((dayDate, index) => (
					<Day
						...
						events={events.filter(event => {
							const curEvent =
								DateUtils.DateConverters.stringSecsToDate(
									event.dateStart
								)
							return (
								curEvent.getFullYear() ==
									dayDate.getFullYear() &&
								curEvent.getMonth() == dayDate.getMonth() &&
								curEvent.getDate() == dayDate.getDate()
							)
						})}
					/>
				))}
